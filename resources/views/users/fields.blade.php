...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('country_id', null, ['class' => 'form-control','maxlength' => 255,'maxlength' => 255]) !!}
</div>
...
<div class="form-group col-sm-6">
    <div class="form-check">
        {!! Form::hidden('is_actively_seeking_employment', 0, ['class' => 'form-check-input']) !!}
        {!! Form::checkbox('is_actively_seeking_employment', '1', null, ['class' => 'form-check-input']) !!}
        {!! Form::label('is_actively_seeking_employment', 'Is Actively Seeking Employment', ['class' => 'form-check-label']) !!}
    </div>
</div>
